    ...
    try {
      ...
      if (videoFileName) {
        ...
        if (await fsPromises.access(videoPath).catch(() => false)) {
          ...
          console.log("تم حذف الفيديو القديم:", videoPath);
        }
      }
      next();
    } catch (error) {
